...
Дан массив из заглавных англ. букв. Нужно найти максимальный кол-во последовательных одинаковых букв, если мы можем заменить k букв на такие же. Т.е. нужно найти макс. размер окна и так далее.
